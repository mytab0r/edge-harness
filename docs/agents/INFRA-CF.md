...
Собранное здесь — прогон, а не пересказ доков (issue #322, реальные запуски
[cf-inventory#33975231091](https://github.com/mytab0r/edge-harness/actions/runs/33975231091)
и [#33975422670](https://github.com/mytab0r/edge-harness/actions/runs/33975422670)).
...
## Что реально доступно (таблица, проверено прогоном 2026-09-05)
