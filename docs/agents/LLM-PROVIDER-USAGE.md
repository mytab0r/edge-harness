...
|---|---|---|---|
| `ai-review` | `default-chain` | 3 | dsh_run_with_provider_chain (scripts/review/ai_dsh.sh) — полный failover |
| `worker` | `default-chain` | 3 | dsh_run_with_provider_chain (scripts/worker/task.sh) — полный failover |
| `hands` | `default-chain` | 3 | dsh_run_with_provider_chain (scripts/hands/dsh_task.sh) — полный failover (#805) |
