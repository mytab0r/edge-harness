...
- [23. Нативное vs своё](research/23-platform-native-vs-custom.md) — где мы написали
  ...
  (auto-merge + метки-как-статусы, Cron Triggers vs alarm, git-ref-замок).
- [30. Отвергнутые варианты](research/30-rejected-alternatives.md) — **обязательно к прочтению
  перед любым предложением по архитектуре.** Варианты с причиной отказа и
  условием, при котором к ним стоит вернуться (список растёт, число не фиксируем).
