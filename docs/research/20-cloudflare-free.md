...
Проверено живыми GET-запросами в CI ([запуск на финальном коде](https://github.com/mytab0r/edge-harness/actions/runs/34173437319),
SHA `3826fbf`, 2026-09-08, 12/12 секций успешно), не по докам. **Это
...
обновления этой ссылки (сделано после правки heredoc «Расход по квотам» —
предыдущий прогон `#34171250101`/`3dea828` отработал код до этой правки).
