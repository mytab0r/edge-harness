...
# Масштаб находки (аудит потока задач 2026-09-06: 25/74 задач за сутки заводит
# автомат, 47% случайной выборки — «хвосты», которые правило репозитория «чинить
# в том же PR» требует дописывать, а не выносить issue). Обязательное второе
# поле блока задачи, сразу после заголовка — критерий различения в ai_prompt.md.
