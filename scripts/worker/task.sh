...
# (DSH_CHAIN_DEADLINE_EPOCH). Худший легитимный прогон теперь: нога пула
# (нож 7200с + бюджет ожиданий 1800с = 150 мин) + бюджет цепочки 150 мин +
# ≤2 мин оверхеда ≈ 302 мин из 340 (worker.yml) — арифметика живёт ОДНИМ
# местом в комментарии инварианта 21 (repo_invariants.py, над
# WORKER_RUN_LONG_RUNNING_MINUTES), не здесь и не в worker.yml.
#
