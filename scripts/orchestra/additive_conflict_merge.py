...
дубликатом и отказывает всей пачке. На живом корпусе это 13 файлов из 153
(было 12 до раунда 10 — объявление без значения `declare -A m` добавило один
файл; цена названа числом, а не оценкой).
...
def _shell_defined_names(text: str) -> list:
    ...
    for line in text.split("\n"):
        bare = _SH_DECLARE_BARE_RE.match(line)
        if bare:
