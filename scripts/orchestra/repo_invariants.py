...
#      расследовал ПОДМНОЖЕСТВО этих же маркеров (26 из 174, окно
...
#      GitHub Actions, не прогон orchestra.yml». Этот инвариант находит
#      ШИРЕ (174, с 2026-09-06 по как минимум 2026-09-13) и держит эту же
#      проверку постоянно, а не разовым расследованием.
#
