...
замер 2026-09-08 (до #827, когда воркер был один на весь репозиторий и ровно
один workflow_dispatch уходил за пульс): 25 конфликтных PR из 38 открытых,
ни один не сливается — это 25 отдельных агентских проходов, каждый жжёт
квоту дефицитного
