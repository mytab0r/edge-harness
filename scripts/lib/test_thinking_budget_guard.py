...
Покрываются ОБЕ ветки `dsh_patch_profile` — плоская (цепочка провайдеров) и
combo-router: каждая пишет свой YAML, и первая версия правки #1533 легла ровно
в одну из них, оставив вторую невалидной и молча.
