...
Задача: #20. Заменяет решение ADR 0011. ADR: [0015](../../../docs/decisions/0015-inbox-dispatch-no-new-secret.md).
...
- ADR 0011 помечен ЗАМЕНЁННЫМ, новый ADR 0015 — с явным разбором, почему
