...
## Доработка (#1130, решение владельца): превентивный рефреш долгоживущих токенов

Владелец спросил дословно: «Какой опус он там пытается рефрешить, если мы
поставили долгоживущие OAuth токены, которые не надо рефрешить?». Разбор —
