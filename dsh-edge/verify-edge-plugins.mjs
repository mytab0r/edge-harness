 ...
 *     алиасом из DSH_EDGE_EXTRA_ALIAS_SCOPES (с бампа #1164 — штатный
 *     механизм апстрима 0.14.1 вместо снятого патча 0001; скоуп задаёт шаг
 *     сборки из manifest.mjs::PLUGIN_SCOPE) и при неразрешении валит сборку,
 *     так что литерал в бандле доказывает: композиция собрана и код плагина
 *     внутри.
