...
window.EDGE_CONFIG = {
  ...
  routes: {
    ...
    taskSnapshots: "/api/tasks-snapshot",
    taskSnapshot: "/api/tasks-snapshot/",
    prSnapshots: "/api/pr-snapshot",
    prSnapshot: "/api/pr-snapshot/",
    session: "/api/session",
    ...
    ready: "/api/ready",
    messagesIssueCreated: "/api/messages/issue-created",
  },
  replayPageSize: 200,
