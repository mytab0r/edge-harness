/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5e3999c1d6df6ed83ee2041a264cc6a8)
// Runtime types generated with workerd@1.20260831.1 2026-08-14 
// Secrets (HANDS_TOKEN, SESSION_SECRET, GH_DISPATCH_TOKEN) are not in vars;
// they are set via `wrangler secret put` and exist at runtime.
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GH_REPO" | "HANDS_TOKEN" | "SESSION_SECRET" | "GH_DISPATCH_TOKEN">> {}
}
