...
export const RETENTION = {
  ...
  batchSize: 500,
  /** Журнал событий: возраст, БЕЗ разбора по статусу задачи. Job физически не
   *  может идти дольше 6 ч (лимит job'а GitHub Actions — таблица в AGENTS.md),
   *  поэтому 14 суток гарантированно не заденут ни одно ещё живое событие.
   *  Ценность журнала — отладка конкретного прогона и replay; после недель
   *  разбора никто к нему не возвращается. */
