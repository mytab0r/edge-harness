...
// умеет (инструменты агента) и живой статус из канала конвейера (чтение —
// /api/harness/events на стороне морды, патч 0005): каждый деплой пишет integration_status
...
// (openspec/specs/journal-tasks-hands.md; с #86 маршрут живёт на морде —
// сессия конвейера, патч 0005; same-origin, кука владельца морды).
